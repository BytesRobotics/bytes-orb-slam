...
public:
    ...
    std::shared_ptr<std::vector<cv::Point3d>> transform_keypoints(const std::shared_ptr<Frame>& transforming_frame);
    ...
    tf2::Quaternion imu_orientation; //! Absolutely referenced orientation
    tf2::Transform wheel_odom; //! Odom references to starting position based on wheel movements
